 ...
 * @author ONS
 */
public class Afficher_Actualites_MembreController implements Initializable{
    
    public static ActualiteService actualiteService = new ActualiteService();
    public static Actualite actualite_a_ouvrir = new Actualite();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            Logger.getLogger(Afficher_Actualites_MembreController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
	...
	private Node loadNewItemNode() {
		try {
			return FXMLLoader.load(getClass().getResource("/gui/Item_details_actualite.fxml"));
		} catch (IOException e) {
	...
	private void setupActions(Node node, Actualite actualite, int index) {
                ...
                Button ouvrir = (Button) node.lookup(".item_action_ouvrir");
		ouvrir.setOnMouseClicked(OpenEventHandler(actualite, index));
	}
	...
	private void setHoverStyleForNode(Node[] nodes, int i) {
        ...
        private EventHandler<MouseEvent> OpenEventHandler(Actualite actualite, int index) {
		return event -> {
			
                   try {
                       actualiteService.compter(actualite);
                                       actualite_a_ouvrir=actualite;

				AnchorPane newLoadedPane = FXMLLoader.load(getClass().getResource("/gui/Details.fxml"));
