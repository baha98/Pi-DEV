...
namespace GestionLocationBundle\EventListener;
    ...
    public function loadEvents(CalendarEvent $calendarEvent)
    {
        ...
        foreach($companyEvents as $companyEvent) {
            ...
            if ($companyEvent->getAllDayEvent() === true ) {
                ...
                $eventEntity = new EventEntity($companyEvent->getIdUser()->getPrenomMembre(), $companyEvent->getDateDebut(), $companyEvent->getDateFin());
            } else {
